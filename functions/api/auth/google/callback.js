import { cookie, makeSession, origin, readCookie, upsertClient } from '../../../_lib.js';
...
export async function onRequestGet({ request, env }) {
  ...
  try { await upsertClient(env, profile.email, profile.name || profile.email); } catch (error) { console.error('CLIENT_UPSERT_FAILED', error); }
